...
Next, the variables affected by the condition and/or batch effects (denoted here by $C$ and 
$B$, respectively) are sampled randomly among the full set of variables. The number of 
variables affected by each type of effect is determined by the user. 
...
More formally, let $y_{ij}^0\in N(10,2)$ denote the base expression level of variable $i$ 
